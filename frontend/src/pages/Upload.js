  ...
  return (
    <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-gray-900 dark:text-gray-100">
      ...
      <div className="flex justify-between items-center mt-6">
        <Link
          to="/library"
          className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-100 rounded-md font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition"
        >
